    ...
    <div class="box-body"> 
        <div class="form-group">
            ...
            <select name="kode_pasien" id="kode_pasien" class="form-control">
                ...
                <?php $ps=$this->db->query("SELECT * FROM pasien where kategori_pasien='BPJS'")->result();?>
    ...
    <div class="box-body"> 
        <div class="form-group">
            ...
            <select name="kode_rumah_sakit" id="kode_rumah_sakit" class="form-control">
                ...
                <?php $rs=$this->db->query("SELECT * FROM rumah_sakit_rujukan")->result();?>
...
function load_data_temp1()
        {
            ...
            $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/load_temp1')?>",
...
function load_data_temp2()
        {
            ...
            $.ajax({
                type:"GET",
               url:"<?php echo base_url('surat_umum/load_temp2')?>",
                data:"no_surat="+no_surat,
...
function load_data_temp3()
        {
            ...
            $.ajax({
                type:"GET",
               url:"<?php echo base_url('surat_umum/load_temp3')?>",
                data:"no_surat="+no_surat,
...
function load_data_temp4()
        {
            ...
            $.ajax({
                type:"GET",
               url:"<?php echo base_url('surat_umum/load_temp4')?>",
                data:"no_surat="+no_surat,
         ...
         function hapus_penyakit(id)
        {
            $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/hapus_temp1')?>",
                data:"id="+id,
         ...
         function hapus_diagnosa(id)
        {
            $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/hapus_temp2')?>",
                data:"id="+id,
                success:function(html){
                  $("#datad"+id).hide(500);
                  load_data_temp2();
         ...
         function hapus_pemeriksaan(id)
        {
            $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/hapus_temp3')?>",
                data:"id="+id,
                success:function(html){
                  $("#datapm"+id).hide(500);
                  load_data_temp3();
         ...
         function hapus_obat(id)
        {
            $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/hapus_temp4')?>",
                data:"id="+id,
                success:function(html){
                  $("#datao"+id).hide(500);
                  load_data_temp4();
        ...
        function add_penyakit()
        {
            ...
            else
            {
             $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/input_penyakit')?>",
        ...
        function add_diagnosa()
        {
            ...
            else
            {
             $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/input_diagnosa')?>",
        ...
        function add_pemeriksaan()
        {
            ...
            else
            {
             $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/input_pemeriksaan')?>",
        ...
        function add_obat()
        {
            ...
            else
            {
             $.ajax({
                type:"GET",
                url:"<?php echo base_url('surat_umum/input_obat')?>",
